...
<body>
    ...
    <!-- Image 169 (Logo SHLL) -->
    <img class="svg-logo" src="assets/images/Logo_SHLL.png" alt="Logo SHLL" />

    <!-- Image 162 (Long Logo SHLL) -->
    <img class="svg-new-img" src="assets/images/Logo_SHLL_long.png" alt="Logo SHLL Long" />
...
console.log("Successfully updated shll-effect.html with actual logo images!");

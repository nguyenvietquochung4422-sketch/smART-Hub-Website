...
let base64_image2 = ""; // Logo
let base64_image3 = ""; // New image
...
if (!base64_image2 || !base64_image3) {
    console.error("Could not extract both base64 images.");
    process.exit(1);
}

// Build the HTML with the direct image inside the pattern.
...
<body>
    ...
    <!-- SVG 1: Logo SHLL (92x107, matrix mirrored, with direct image inside pattern) -->
    <svg class="svg-logo" viewBox="0 0 92 107" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <defs>
            <pattern id="pattern0_850_265" patternContentUnits="objectBoundingBox" width="1" height="1">
                <image href="data:image/png;base64,${base64_image2}" xlink:href="data:image/png;base64,${base64_image2}" width="2455" height="498" transform="matrix(0.00303446 0 0 0.00261005 -6.4496 -0.42053)" preserveAspectRatio="none"/>
            </pattern>
        </defs>
    </svg>

    <!-- SVG 2: New Image (265x166, with direct image inside pattern) -->
    <svg class="svg-new-img" viewBox="0 0 265 166" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <defs>
            <pattern id="pattern0_818_670" patternContentUnits="objectBoundingBox" width="1" height="1">
                <image href="data:image/png;base64,${base64_image3}" xlink:href="data:image/png;base64,${base64_image3}" width="2261" height="305" transform="matrix(0.00186423 0 0 0.00297043 0.0500229 0.0461065)" preserveAspectRatio="none"/>
            </pattern>
        </defs>
    </svg>
...
console.log("Successfully fixed and generated shll-effect.html");
